<?php 
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        $name = htmlspecialchars(trim($_POST['name'])); //La fonction TRIM supprime les caractères d'espacement du début et de la fin d'une chaîne.
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select id="form_title" name="title" class="form-control" data-error="Please specify your title.">
